function initCanvas(){
    ...
    var enemiespic1  = new Image(); // enemies 1
    var enemiespic2 = new Image(); // enemies 2
    ...
    var enemies = [
                   new enemyTemplate({id: "weapon1", x: 100, y: -20, w: 50, h: 30 }),
                   new enemyTemplate({id: "weapon2", x: 225, y: -20, w: 50, h: 30 }),
                   new enemyTemplate({id: "weapon3", x: 350, y: -20, w: 80, h: 30 }),
                   new enemyTemplate({id: "weapon4", x:100,  y:-70,  w:80,  h: 30}),
                   new enemyTemplate({id: "weapon5", x:225,  y:-70,  w:50,  h: 30}),
                   new enemyTemplate({id: "weapon6", x:350,  y:-70,  w:50,  h: 30}),
                   new enemyTemplate({id: "weapon7", x:475,  y:-70,  w:50,  h: 30}),
                   new enemyTemplate({id: "weapon8", x:600,  y:-70,  w:80,  h: 30}),
                   new enemyTemplate({id: "weapon9", x:475,  y:-20,  w:50,  h: 30}),
                   new enemyTemplate({id: "weapon10",x: 600, y: -20, w: 50, h: 30}),

                   // Segundo group de enemies
                   new enemyTemplate({ id: "weapon11", x: 100, y: -220, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon12", x: 225, y: -220, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon13", x: 350, y: -220, w: 80, h: 50, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon14", x: 100, y: -270, w: 80, h: 50, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon15", x: 225, y: -270, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon16", x: 350, y: -270, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon17", x: 475, y: -270, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "weapon18", x: 600, y: -270, w: 80, h: 50, image: enemiespic2 }),
                 ];
